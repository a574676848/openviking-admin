...
用法:
  ...
  ova kb detail --id <kbId> [--profile dev] [--output json|jsonl]
    ova kb delete --id <kbId> [--profile dev] [--output json|jsonl]
  ova tree list --kb <kbId> [--profile dev] [--output json|jsonl]
  ova tree detail --id <nodeId> [--profile dev] [--output json|jsonl]
    ova tree delete --id <nodeId> [--profile dev] [--output json|jsonl]
  ova documents import <url> --kb <kbId> [--type url|manifest|local] [--parent <nodeId>] [--name <sourceName>] [--profile dev] [--output json|jsonl]
