...
![平台首页概览](../docs/images/platform_home.png)
...
![知识库管理界面](../docs/images/knowledge_bases.png)
...
OpenViking Admin 支持将知识库发布为面向外部访问的只读知识站点，提供目录导航与全文检索：

![知识站点公开页面](../docs/images/site_page.png)
