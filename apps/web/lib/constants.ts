...
export const API_ENDPOINTS = {
  ...
  TENANT_MIGRATIONS: {
    BASE: '/api/v1/tenant-migrations',
    TENANTS: '/api/v1/tenant-migrations/tenants',
    PRECHECK: '/api/v1/tenant-migrations/precheck',
    TASKS: '/api/v1/tenant-migrations/tasks',
    PLATFORM_PRECHECK: '/api/v1/tenant-migrations/platform/precheck',
    PLATFORM_TASKS: '/api/v1/tenant-migrations/platform/tasks',
  },
  USERS: '/api/v1/users',
